...
-   [1. GPU에 데이터를 저장할 메모리 (VBO, EBO)](#1-gpu에-데이터를-저장할-메모리-vbo-ebo)
-   [2. 셰이더 프로그램 (버텍스 셰이더, 프래그먼트 셰이더)](#2-셰이더-프로그램-버텍스-셰이더-프래그먼트-셰이더)
-   [3. 데이터와 셰이더 프로그램을 연결하는 과정](#3-데이터와-셰이더-프로그램을-연결하는-과정)
-   [전체 과정](#전체-과정)
-   [정리](#정리)
